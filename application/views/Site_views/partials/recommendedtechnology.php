	<?php $recommended = get_recommended_technologynews();?>
	<!-- <h4 class="section-title title">Texnologiya xeberleri</h4> -->
			...
			<li>
				<div class="post small-post">
					...
					<div class="post-content">
						...
						<h5  class="entry-title">	<a href="#"><?=$cat_name[$news['catid'] ]?></a></h3>
						</div>
