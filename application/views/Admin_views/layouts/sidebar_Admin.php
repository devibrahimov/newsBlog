...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="<?php if($type ==='1'){echo 'active';}?>"><a href="<?=site_url('');?>"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
...
<li class="<?php if($type ==='abune'){echo 'active';}?>"><a href="<?=site_url('admin/chipSubscribes');?>"><i class="fa fa-child"></i> <span>Chip abuneleri</span></a></li>
    ...
    <!-- <li class=""><a href="<?=site_url('admin/setting');?>"><i class="fa fa-wrench"></i> <span>Tənzimləmələr</span></a></li> -->
  </ul> <!-- /.sidebar-menu -->
</section>
<!-- /.sidebar -->
</aside>
